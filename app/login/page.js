const ERROR_MESSAGES = {
  ...
  // 동의 화면의 "Google 캘린더 / Google Tasks" 체크박스를 끈 채로 넘어온 경우.
  missing_scope:
    "캘린더와 할일 권한이 필요해요. 구글 동의 화면에서 체크박스를 모두 켠 뒤 계속을 눌러주세요.",
  reauth: "Google 접근 권한이 만료됐거나 부족해요. 다시 로그인하면서 권한을 모두 허용해주세요.",

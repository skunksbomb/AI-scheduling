...
피드백은 맨 위 원본 메모의 해석보다 우선합니다 — 사용자가 어떤 값을 빼라고 하면(예: "마감 빼줘")
원본 메모에 그 정보가 남아있더라도 해당 필드를 반드시 null로 두세요. 그리고 피드백 문장에 나온
단어를 새 항목이나 새 필드를 만들 근거로 삼지 마세요 — 피드백은 "이번 배치를 어떻게 고칠지"에
대한 지시일 뿐, 새로 적은 메모가 아닙니다.)
${roundsText}`;
